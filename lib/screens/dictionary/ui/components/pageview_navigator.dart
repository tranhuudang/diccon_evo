...
import 'package:diccon_evo/screens/commons/rectangle_button.dart';
...
class PageViewNavigator extends StatefulWidget {
  const PageViewNavigator({
    super.key,
    this.height = 500,
    required this.controller, required this.itemCount,
  });
        ...
        children: [
          StreamBuilder(
              ...
              builder: (context, currentPage) {
                return Row(
                  children: [
                    currentPage.data > 1 ? RectangleButton(
                    ...
                    const Spacer(),
                    currentPage.data < widget.itemCount ? RectangleButton(
