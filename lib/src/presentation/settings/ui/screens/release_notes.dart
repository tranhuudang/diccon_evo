      ...
      body: ListView(
        children: const [
          ReleaseNotesItem(
            ...
            date: '21-06-2024',
            changesNote: [
              'Sửa lỗi dịch sai định dạng với phiên bản cũ',
              'Khắc phục lỗi thoát ứng dụng khi vào Đối thoại trên Windows',
              'Thêm truyện mới',
            ],
          ),
          ReleaseNotesItem(
          ...
          ReleaseNotesItem(
            ...
            date: '10-06-2024',
            changesNote: [
              'Khắc phục sự cố mất kết nối với trí tuệ nhân tạo',
              'Tối ưu quy trình gỡ rối ứng dụng',
              'Nâng cao bảo mật cho ứng dụng'
            ],
          ),
          ReleaseNotesItem(
            version: '668',
            date: '07-06-2024',
            changesNote: [
              'Cải thiện chất lượng câu trả lời trong từ điển và truyện đọc',
            ],
          ),
          ReleaseNotesItem(
            version: '666',
            date: '05-06-2024',
            changesNote: [
              'Cải thiện chất lượng câu trả lời trong từ điển',
            ],
          ),
          ReleaseNotesItem(
            version: '664',
