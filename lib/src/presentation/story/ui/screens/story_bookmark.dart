...
class _StoryListBookmarkViewState extends State<StoryListBookmarkView> {
  ...
  Widget build(BuildContext context) {
    final storyBookmarkBloc = context.read<StoryBookmarkBloc>();
    return  RefreshIndicator(
      ...
      child: BlocConsumer<StoryBookmarkBloc, StoryBookmarkState>(
            ...
            builder: (context, state) {
              switch (state) {
                ...
                default:
                  storyBookmarkBloc.add(FetchStoryBookmarkFromFirestore());
                  return Scaffold(
                    appBar: AppBar(title: Text("Bookmarks".i18n),),
                    body: const Center(
                      child: SizedBox(
