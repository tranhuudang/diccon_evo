...
class BottomSheetTranslationGemini extends StatefulWidget {
  final String searchWord;
  final Function(String)? onWordTap;
  final String sentenceContainWord;
  const BottomSheetTranslationGemini(
      {super.key,
      this.onWordTap,
  ...
  @override
  State<BottomSheetTranslationGemini> createState() =>
      _BottomSheetTranslationGeminiState();
}

class _BottomSheetTranslationGeminiState
    extends State<BottomSheetTranslationGemini> {
