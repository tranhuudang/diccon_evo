...
class _ChatBotBubbleState extends State<ChatBotBubble>
  ...
  Future<void> _createFirebaseDatabaseItem() async {
    ...
    final databaseRow =
        FirebaseFirestore.instance.collection(FirebaseConstant.firestore.dictionary).doc(answerId);
    final json = {
  ...
  void _getGptResponse() async {
    ...
    if (widget.listChatGptRepository[widget.index].singleQuestionAnswer.answer
      ...
      final docUser =
          FirebaseFirestore.instance.collection(FirebaseConstant.firestore.dictionary).doc(answer);
